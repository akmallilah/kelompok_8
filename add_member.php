            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="card shadow col-mb-2">
                            ...
                            <table >
                                ...
                                <div>
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><input type="text" name="tmplahir" id="tmplahir" autocomplete="off">, <input type="date" name="tgllahir" id="tgllahir" ></td>
                                    </tr> 
                                </div>
                                ...
                                <div>
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><input type="text" name="alamat" id="alamat" required autocomplete="off"></td>
                                    </tr> 
                                </div>
                                <div>
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><input type="text" name="kamar" id="kamar" required autocomplete="off"></td>
                                    </tr> 
                                </div>
                        ...
                        <?php 
                        if(@$_POST['submit']){
                            $query = mysqli_query($conn, "INSERT INTO member (nama,
                                                                                tmplahir,
                                                                                tgllahir,
                                                                                alamat,
                                                                                kamar)
                        ...
                        if($query){
                            ...
                            document.location="tampil/member.php"</script>';
                        }else{
