            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="card shadow col-mb-2">
                            ...
                            <table >
                                <div>
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><input type="text" name="kelas" id="kelas" autofocus autocomplete="off" required></td>
                                    </tr> 
                                </div> 
                                <div>
                                    <tr>
                        ...
                        <?php 
                        if(@$_POST['submit']){
                            $query = mysqli_query($conn, "INSERT INTO kelas (kelas)
                                                                        VALUES(
                                                                              '$_POST[kelas]
                                                                              )");
                        if($query){
